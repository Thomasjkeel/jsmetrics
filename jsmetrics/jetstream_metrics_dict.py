...
#    3.1 for 'plev' coord it is in millibars and higher pressure is considered
#        the minimum value (e.g. 85000 mbar - 50000 mbar)
...
JETSTREAM_METRIC_DICT = {
    ...
    "Kuang2014": {
        ...
        "description": "Kuang et al. 2014. NOTE: Should be 200hPa only",
    },
    "FrancisVavrus2015": {
        "variables": ["ua", "va"],
        "coords": {"plev": [50000, 50000]},
        "metric": jetstream_metrics.francis_vavrus_2015,
        "description": "Francis & Vavrus 2015",
    },
    # "LocalWaveActivity":
