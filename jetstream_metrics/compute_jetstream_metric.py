...
JETSTREAM_METRICS = {
    ...
    "ScreenSimmonds2014":
        {"variables":["zg"], "coords":{"plev": [50000]}, "metric": jetstream_metrics.screen_and_simmonds_2014, "description":"Screen & Simmonds 2014"},
    "Kuang2014":
        {"variables":["ua"], "coords":{"plev": [20000]}, "metric": jetstream_metrics.kuang_et_al_2014, "description":"Kuang et al. 2014"},
    "HuangNakamura2015":
        {"variables":["rv850?"], "coords":{"plev": ["Unknown"]}, "metric": jetstream_metrics.huang_and_nakamura_2015, "description":"Huang & Nakamura 2015"},
    "Cattiaux2016":
        {"variables":["zg"], "coords":{"plev": [50000]}, "metric": jetstream_metrics.cattiaux_et_al_2016, "description":"Cattiaux et al. 2016"},
    "Ceppi2018":
        {"variables":["ua"], "coords":{"plev": [85000]}, "metric": jetstream_metrics.ceppi_et_al_2018, "description":"Ceppi et al. 2018"},
    "Kern2018":
        {"variables":["ua", "va"], "coords":{"plev": [100000,0]}, "metric": jetstream_metrics.kern_et_al_2018, "description":"Kern 2018"},
    "Simpson2018":
        {"variables":["zg"], "coords":{"plev": [70000]}, "metric": jetstream_metrics.simpson_et_al_2018, "description":"Simpson et al. 2018"},
    "ChemkeMing2020":
