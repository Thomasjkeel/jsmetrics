...
class TestPlot(unittest.TestCase):
    def setUp(self):
        ...
        self.metric_computer = compute_metrics.MetricComputer(
    ...
    def test_plot(self):
        self.result = self.metric_computer.compute_metric_from_data(
            "Woolings2010", calc_kwargs={"filter_freq": 1, "window_size": 2}
        )
