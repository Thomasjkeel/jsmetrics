...
JETSTREAM_METRIC_DICT = {
    ...
    "PenaOrtiz2013":
        {"variables": ["ua", "va"], "coords":{"plev": [10000, 40000]}, "metric": jetstream_metrics.penaortiz_et_al_2013, "description": "Pena-Ortiz et al. 2013"},
    # "ScreenSimmonds2013":
    ...
    "GrisePolvani2017":
        {"variables": ["ua"], "coords":{"plev":[85000, 85000], "lat": [-65, -30]}, "metric": jetstream_metrics.grise_polvani_2017, "description": "Grise & Polvani 2017"},
    # "Molnos2017":
