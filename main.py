import argparse
from experiments import get_available_metrics, calculate_a_metric
...
ALL_EXPERIMENTS = {'get_available_metrics':{"description": "Will print out all metrics available for this dataset","script":get_available_metrics.main},
                   'calc_metrics':{"description":"will calcualte any number of metrics. Use -m tag to state which one", "script":calculate_a_metric.main},
