...
class TestPlot(unittest.TestCase):
    def setUp(self):
        ...
        UKESM1_SSP585['time'] = np.array(['2015-01-01T00:00:00.000000000',\
        '2015-01-02T00:00:00.000000000','2015-02-01T00:00:00.000000000',\
        '2015-02-02T00:00:00.000000000','2015-02-03T00:00:00.000000000'], dtype='datetime64[ns]')
        self.metric_computer = compute_metrics.MetricComputer(UKESM1_SSP585,\
    ...
    def plot_fig(self, save=False):
        ...
        ax.plot(max_ws)
        ax.plot(ff_max_ws)
        plt.legend(['latitude', 'fourier filtered latitude', 'windspeed',\
                 'fourier filtered wind-speed'])
        if save:
            fig.savefig('tests/figures/woolings_test.png', bbox_inches='tight')

    def test_plot(self):
        self.result = self.metric_computer.compute_metric_from_data('Woolings2010',\
                     calc_kwargs={"filter_freq":1, "window_size":2})
